...
CHAPTERS.push({
  ...
  {type:"place", name:"Lá thần cứu người", cols:4, rows:3,
   ...
   env:[{id:"ao",cells:[[0,1],[0,2]]},{id:"caythuoc",cells:[[3,0]]}], blocked:[], mud:[],
   ...
   cons:[{t:"adjEnv",c:"cogai",e:"ao",txt:"Cô gái vừa được vớt lên, nằm bên bờ ao"},
         ...
         {t:"adjChar",c:"cho",target:"cuoi",txt:"Chó vàng quấn quýt bên chân"}],
  ...
  {type:"place", name:"Nói dối như Cuội", cols:4, rows:3,
   ...
   env:[{id:"ao",cells:[[0,0]]},{id:"cayda",cells:[[3,0]]},{id:"tre",cells:[[0,2]]}], blocked:[], mud:[],
   chars:["cuoi","vocuoi"],
  ...
  {type:"place", name:"Tưới nhầm!", cols:5, rows:4,
   ...
   env:[{id:"caythuoc",cells:[[2,1]]},{id:"nha",cells:[[0,0]]},{id:"tre",cells:[[4,0],[4,1]]}], blocked:[], mud:[[1,1],[1,2]],
   ...
   cons:[{t:"adjEnv",c:"cuoi",e:"tre",txt:"Cuội đốn củi tận rừng xa"},
         ...
         {t:"adjChar",c:"cho",target:"vocuoi",txt:"Chó vàng sủa cuống quýt bên cạnh"}],
  ...
  {type:"place", name:"Níu rễ cây", cols:4, rows:4,
   ...
   env:[{id:"cayda",cells:[[1,1]]},{id:"nha",cells:[[3,3]]}], blocked:[], mud:[],
   chars:["cuoi","vocuoi","cho"],
   cons:[{t:"onEnv",c:"cuoi",e:"cayda",txt:"Cuội níu chặt rễ — cây kéo cả người lên!"},
         {t:"adjChar",c:"vocuoi",target:"cho",txt:"Vợ ôm con chó vàng đứng nhìn theo"},
         {t:"notAdjEnv",c:"vocuoi",e:"cayda",txt:"…với không tới nữa rồi"}],
