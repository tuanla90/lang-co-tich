...
CHAPTERS.push({
  ...
  {type:"place", name:"Dính cả chùm!", cols:5, rows:3,
   scene:"“<b>Khắc nhập! Khắc nhập!</b>” — Phú ông vừa chạm tay vào cây tre liền <b>dính chặt</b>! Công tử lao vào kéo — dính nốt! Cả người lẫn tre phải <b>liền thành một chùm</b>. Khoai đứng ngoài cổng, tủm tỉm…",
   ...
   cons:[{t:"queue",cs:["dot1","dot2","phuong","chure"],txt:"Dính theo thứ tự: gốc tre → đốt tre → phú ông → công tử"},
