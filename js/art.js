...
PLACES.boao = {name:"Bờ ao", svg:`<svg viewBox="0 0 60 60"><rect x="0" y="26" width="60" height="34" fill="#9CC6D6"/><rect x="0" y="20" width="60" height="8" fill="#8FB06A" stroke="#3B2B1E" stroke-width="2"/><path d="M8 38 Q16 33 24 38 M30 48 Q38 43 46 48" stroke="#F1F7F5" stroke-width="2.5" fill="none" stroke-linecap="round"/><circle cx="46" cy="34" r="5" fill="#DE7BA4" stroke="#3B2B1E" stroke-width="2"/></svg>`};
PLACES.songbien = {name:"Sông biển", svg:`<svg viewBox="0 0 60 60"><rect x="0" y="18" width="60" height="42" fill="#7FB3C8"/><path d="M0 30 Q10 24 20 30 T40 30 T60 30 M0 42 Q10 36 20 42 T40 42 T60 42 M0 53 Q10 47 20 53 T40 53 T60 53" stroke="#F1F7F5" stroke-width="2.5" fill="none"/><path d="M34 8 L34 24 L48 24 Z" fill="#F7F1E0" stroke="#3B2B1E" stroke-width="2.5"/><path d="M34 8 V26" stroke="#3B2B1E" stroke-width="2.5"/></svg>`};
PLACES.suoi = {name:"Suối", svg:`<svg viewBox="0 0 60 60"><path d="M22 0 Q34 16 20 30 Q6 44 26 60 L40 60 Q22 44 34 30 Q48 16 36 0 Z" fill="#7FB3C8" stroke="#3B2B1E" stroke-width="2"/><circle cx="10" cy="16" r="6" fill="#9AA5A8" stroke="#3B2B1E" stroke-width="2"/><circle cx="50" cy="38" r="7" fill="#9AA5A8" stroke="#3B2B1E" stroke-width="2"/><circle cx="46" cy="12" r="4.5" fill="#9AA5A8" stroke="#3B2B1E" stroke-width="2"/></svg>`};

/* --- Núi: biên ải (có luỹ chắn) / rừng núi (có cây) --- */
PLACES.bienai = {name:"Biên ải", svg:`<svg viewBox="0 0 60 60"><path d="M0 52 L14 20 L26 40 L34 26 L48 52 Z" fill="#9AA5A8" stroke="#3B2B1E" stroke-width="2.5"/><path d="M40 52 L54 22 L60 34 L60 52 Z" fill="#8A939A" stroke="#3B2B1E" stroke-width="2.5"/><rect x="20" y="38" width="24" height="16" fill="#C9B27C" stroke="#3B2B1E" stroke-width="2.5"/><path d="M20 38 h24 M24 38 v-5 M32 38 v-5 M40 38 v-5" stroke="#3B2B1E" stroke-width="2.5"/><rect x="28" y="44" width="8" height="10" fill="#8A6E52" stroke="#3B2B1E" stroke-width="2"/></svg>`};
PLACES.rungnui = {name:"Rừng núi", svg:`<svg viewBox="0 0 60 60"><path d="M0 54 L16 22 L30 46 L42 28 L60 54 Z" fill="#9AA5A8" stroke="#3B2B1E" stroke-width="2.5"/><path d="M16 22 L20 30 L16 34 L12 30 Z" fill="#F1F7F5" stroke="#3B2B1E" stroke-width="1.5"/><path d="M10 54 L14 42 L18 54 Z" fill="#4E7038" stroke="#3B2B1E" stroke-width="2"/><path d="M26 54 L30 40 L34 54 Z" fill="#5A7D3C" stroke="#3B2B1E" stroke-width="2"/><path d="M42 54 L46 42 L50 54 Z" fill="#4E7038" stroke="#3B2B1E" stroke-width="2"/></svg>`};

/* --- Nhà: sân nhà (có rào) / nhà trên (giữ hình mái nhà) / làng Phù Đổng (cụm mái) --- */
PLACES.san = {name:"Sân nhà", svg:`<svg viewBox="0 0 60 60"><rect x="0" y="34" width="60" height="26" fill="#E9D9A8"/><path d="M4 34 Q30 26 56 34" stroke="#C89B62" stroke-width="2" fill="none"/><path d="M0 20 L14 8 L28 20 L28 34 L0 34 Z" fill="#C8452A" stroke="#3B2B1E" stroke-width="2.5"/><path d="M36 54 V40 M44 54 V40 M52 54 V40 M32 44 H56" stroke="#8A6E52" stroke-width="3" stroke-linecap="round"/></svg>`};
PLACES.langpd = {name:"Làng Phù Đổng", svg:`<svg viewBox="0 0 60 60"><path d="M2 30 L14 18 L26 30 L26 44 L2 44 Z" fill="#C8452A" stroke="#3B2B1E" stroke-width="2.5"/><path d="M30 38 L40 28 L50 38 L50 50 L30 50 Z" fill="#C9B27C" stroke="#3B2B1E" stroke-width="2.5"/><path d="M34 16 L44 6 L54 16 L54 26 L34 26 Z" fill="#E3A72F" stroke="#3B2B1E" stroke-width="2.5"/><path d="M0 52 Q30 46 60 52" stroke="#5A7D3C" stroke-width="3.5" fill="none"/></svg>`};

/* --- Ruộng đồng: ngoài đồng (lúa) / ruộng bùn (nước đục) / đồng bằng (trải rộng) --- */
PLACES.dong = {name:"Ngoài đồng", svg:`<svg viewBox="0 0 60 60"><rect x="0" y="24" width="60" height="36" fill="#8FB06A" stroke="#3B2B1E" stroke-width="2.5"/><path d="M8 32 V54 M18 30 V56 M28 32 V54 M38 30 V56 M48 32 V54" stroke="#5A7D3C" stroke-width="3.5" stroke-linecap="round"/><circle cx="48" cy="12" r="7" fill="#E3A72F" stroke="#3B2B1E" stroke-width="2.5"/></svg>`};
PLACES.ruongbun = {name:"Ruộng", svg:`<svg viewBox="0 0 60 60"><rect x="0" y="26" width="60" height="34" fill="#A98055" stroke="#3B2B1E" stroke-width="2.5"/><path d="M0 38 H60 M0 50 H60" stroke="#8F6A42" stroke-width="3"/><ellipse cx="16" cy="32" rx="7" ry="3" fill="#C09A6C"/><ellipse cx="42" cy="44" rx="8" ry="3.5" fill="#C09A6C"/><path d="M10 22 V16 M22 22 V14 M34 22 V17" stroke="#5A7D3C" stroke-width="3" stroke-linecap="round"/></svg>`};
PLACES.dongbang = {name:"Đồng bằng", svg:`<svg viewBox="0 0 60 60"><rect x="0" y="30" width="60" height="30" fill="#C9D6A3"/><path d="M0 30 Q15 24 30 30 T60 30" fill="#8FB06A" stroke="#3B2B1E" stroke-width="2"/><path d="M0 44 Q20 40 40 44 T60 42" stroke="#8FB06A" stroke-width="2.5" fill="none"/><path d="M6 56 Q10 50 14 56 M24 58 Q28 52 32 58 M44 56 Q48 50 52 56" fill="#5A7D3C" stroke="#3B2B1E" stroke-width="1.5"/><circle cx="12" cy="14" r="6" fill="#F1E6C8" stroke="#3B2B1E" stroke-width="2"/></svg>`};
